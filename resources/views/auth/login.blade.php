...
<head>
    ...
    <style>html.no-loader #page-loader{display:none!important}</style>
</head>
            ...
            <section class="card">
                ...
                <div class="card-right">
                    <div class="form-box" role="form" aria-labelledby="login-title">
                        ...
                        <form class="login-form" id="loginForm" method="POST" action="{{ route('login.attempt') }}" novalidate>
                            @csrf
      ...
      (function(){
        ...
        form.addEventListener('submit', function(){
          try{
            ...
            if (btn){ btn.disabled = true; btn.style.opacity = .75; btn.style.cursor = 'not-allowed'; }
          }catch(e){}
        });
      })();
    </script>
