            ...
            <div class="modal-body pt-3">
                <form method="POST" id="formBarangKeluar" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label">Kode Barang <small class="text-muted">(Otomatis)</small></label>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="jumlah" id="jumlahKeluar" class="form-control" placeholder="Masukkan Jumlah" required min="1">
                        ...
                        <div class="col-12">
                            ...
                            <div class="border rounded p-4 text-center" style="background-color: #f8f9fa;">
                                <input type="file" name="bukti" id="buktiBrgKeluar" class="d-none" accept="image/*,.pdf">
