{{-- resources/views/staff/pb/laporan-pdf.blade.php --}}
<!DOCTYPE html>
<html lang="id">
...
<head>
    ...
    @php
        ...
        $monthRange = $quarterMonths[$quarter ?? 1] ?? 'JANUARI – MARET';
...
<body>
    ...
    @php
        ...
        $stockOpnameData = app(App\Http\Controllers\Pb\LaporanPDFController::class)->getStockOpnameData(
            $quarter ?? 2,
            $year ?? $tahunSekarang,
        );
