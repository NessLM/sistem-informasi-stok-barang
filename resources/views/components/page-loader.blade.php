{{-- resources/views/components/page-loader.blade.php
  ...
  @once
    <style>
      /* ========================================================================
         PARAMETER UTAMA (bisa dioverride via attribute style di #page-loader)
         ======================================================================== */
      #page-loader{
        /* WARNA */
      ...
      /* 🔑 Hormati flag global dari layout:
         jika <html> punya class no-loader → overlay disembunyikan total */
    ...
    <script>
      ...
      class PageLoader {
        constructor(rootId='page-loader', opts = {}) {
          ...
          this.cfg = Object.assign({
            ...
            simStart: 30,     // simulasi awal (opsional)
      ...
      // 🔒 Guard: jika <html> punya class no-loader → jangan inisialisasi
      document.addEventListener('DOMContentLoaded', () => {
        if (document.documentElement.classList.contains('no-loader')) {
          const el = document.getElementById('page-loader');
          if (el) { el.classList.add('is-hidden'); }
          return; // SKIP start/simulate
        }
